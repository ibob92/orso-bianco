...
const gustiData = [
  {
    ...
    review: {
      ...
      color: "#4285F4",
      date: "3 mesi fa",
      text: "Il pistacchio migliore che abbia mai assaggiato. Cremoso, intenso, non troppo dolce. Da solo vale il viaggio a Castiglione.",
    },
    reverse: false,
  },
  {
    ...
    review: {
      ...
      color: "#EA4335",
      date: "1 mese fa",
      text: "Il limone basilico ananas sembra strano ma è PAZZESCO. Freschissimo. Ci torniamo ogni sera delle vacanze.",
    },
    reverse: true,
  },
  {
    ...
    review: {
      ...
      color: "#34A853",
      date: "2 settimane fa",
      text: "Il caramello salato è strepitoso. Lo prendo sempre doppio. Staff gentilissimo, come entrare a casa.",
    },
    reverse: false,
  },
];
